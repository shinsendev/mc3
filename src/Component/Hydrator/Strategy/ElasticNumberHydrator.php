...
class ElasticNumberHydrator implements HydratorDTOInterface
{
    /**
     ...
     */
    public static function hydrate(DTOInterface $dto, array $data, EntityManagerInterface $em):ElasticIndexationDTO
    {
        $params = [];
     ...
     * @param ElasticIndexationDTO $dto
     * @param EntityManagerInterface $em
     * @return ElasticIndexationDTO
     */
    public static function setSongs(PersistentCollection $songs, ElasticIndexationDTO $dto, EntityManagerInterface $em):ElasticIndexationDTO
    {
        $songsDTO = [];
     ...
     * @return ElasticIndexationDTO
     */
    private static function setAttributes(PersistentCollection $attributes, DTOInterface $dto, EntityManagerInterface $em):ElasticIndexationDTO
    {
