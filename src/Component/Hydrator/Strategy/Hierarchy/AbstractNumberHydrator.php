...
abstract class AbstractNumberHydrator implements HydratorDTOInterface
{
    /**
    ...
    public static function hydrate(DTOInterface $dto, array $data, EntityManagerInterface $em):NumberPayloadInterface
    {
        ...
        /** @var NumberPayloadInterface $dto */
     ...
     * @param NumberPayloadInterface $dto
     * @param EntityManagerInterface $em
     * @return ElasticIndexationDTO
     */
    public static function setSongs(PersistentCollection $songs, NumberPayloadInterface $dto, EntityManagerInterface $em):NumberPayloadInterface
    {
        $songsDTO = [];
     ...
     * @return ElasticIndexationDTO
     */
    private static function setAttributes(PersistentCollection $attributes, NumberPayloadInterface $dto, EntityManagerInterface $em):NumberPayloadInterface
    {
